...
async function validateBackend() {
    ...
    try {
        ...
        if (!school.exists)
            throw new Error('school_1 does not exist.');
        console.log('✅ Firestore: Schools reachable.');
        // 2. Check Auth User and Claims
        const user = await auth.getUser('teacher_1');
        if (!user)
            throw new Error('teacher_1 auth user missing.');
        if (((_a = user.customClaims) === null || _a === void 0 ? void 0 : _a.role) !== 'teacher' || ((_b = user.customClaims) === null || _b === void 0 ? void 0 : _b.schoolId) !== 'school_1') {
        ...
        if (students.empty)
            throw new Error('Students collection is empty.');
...
validateBackend();
//# sourceMappingURL=validate_backend.js.map